...
const urlSpotifyToken = (id, secret) => `https://accounts.spotify.com/api/token?grant_type=client_credentials&client_id=${id}&client_secret=${secret}`;
...
export async function getSpotifyToken() {
    try {
        ...
        const tokenSpotify = await res.json()
